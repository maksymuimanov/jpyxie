...
class ExternalPythonLibraryInitializerTest {
    private ExternalPythonLibraryInitializer initializer;
    @Mock
    ...
    @BeforeEach
    void setUp() {
        initializer = new ExternalPythonLibraryInitializer(pipManager, new PythonLibrary[]{mockLibrary});
    }
