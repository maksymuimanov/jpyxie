 ...
 * @since 1.0.0
 */
public interface PythonRestServerConnectionDetails extends ConnectionDetails {
    /**
    ...
    /**
     * Creates an immutable {@link PythonRestServerConnectionDetails} instance with the given parameters.
     *
     ...
     * @return non-{@code null} {@link PythonRestServerConnectionDetails} instance
     */
    static PythonRestServerConnectionDetails of(String token, String uri) {
        return new PythonRestServerConnectionDetails() {
            @Override
