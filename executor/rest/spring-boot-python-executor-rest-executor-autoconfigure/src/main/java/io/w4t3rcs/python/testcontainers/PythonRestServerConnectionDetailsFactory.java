package io.w4t3rcs.python.testcontainers;

import io.w4t3rcs.python.PythonRestServerContainer;
import io.w4t3rcs.python.autoconfigure.PythonRestServerConnectionDetails;
import org.springframework.boot.testcontainers.service.connection.ContainerConnectionDetailsFactory;
import org.springframework.boot.testcontainers.service.connection.ContainerConnectionSource;

/**
 * Factory for creating {@link PythonRestServerContainerConnectionDetails} from a running
 ...
 * @see PythonRestServerConnectionDetails
 * @see ContainerConnectionDetailsFactory
 * @author w4t3rcs
 * @since 1.0.0
 */
public class PythonRestServerConnectionDetailsFactory extends ContainerConnectionDetailsFactory<PythonRestServerContainer, PythonRestServerConnectionDetailsFactory.PythonRestServerContainerConnectionDetails> {
    /**
    ...
    /**
     * Creates {@link PythonRestServerContainerConnectionDetails} from the given container source.
     *
     * @param source the container connection source
     * @return a non-null connection details object
     */
    @Override
    protected PythonRestServerContainerConnectionDetails getContainerConnectionDetails(ContainerConnectionSource<PythonRestServerContainer> source) {
        return new PythonRestServerContainerConnectionDetails(source);
    }
     ...
     */
    public static class PythonRestServerContainerConnectionDetails extends ContainerConnectionDetails<PythonRestServerContainer> implements PythonRestServerConnectionDetails {
        /**
         ...
         */
        protected PythonRestServerContainerConnectionDetails(ContainerConnectionSource<PythonRestServerContainer> source) {
            super(source);
        }
