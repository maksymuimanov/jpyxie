 ...
 * @author w4t3rcs
 */
public class ProcessReadingException extends RuntimeException {
    /**
     ...
     */
    public ProcessReadingException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public ProcessReadingException(String message) {
        super(message);
    }
}
