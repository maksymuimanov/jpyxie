...
public class SpelythonResolver implements PythonResolver {
    ...
    public SpelythonResolver(PythonSerializer pythonSerializer, ApplicationContext applicationContext) {
        this(pythonSerializer, applicationContext, DEFAULT_REGEX, DEFAULT_LOCAL_VARIABLE_INDEX, DEFAULT_POSITION_FROM_START, DEFAULT_POSITION_FROM_END);
    }
        ...
        return BasicPythonScriptBuilder.of(pythonScript)
                ...
                .replaceAllCode(this.regex,
                    ...
                    try {
                        ...
                        PythonRepresentation pythonRepresentation = pythonSerializer.serialize(expressionValue);
