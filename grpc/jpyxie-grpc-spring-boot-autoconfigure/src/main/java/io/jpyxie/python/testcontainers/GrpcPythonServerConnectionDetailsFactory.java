package io.jpyxie.python.testcontainers;

import io.jpyxie.python.PythonGrpcServerContainer;
import io.jpyxie.python.autoconfigure.GrpcPythonServerConnectionDetails;
import org.springframework.boot.testcontainers.service.connection.ContainerConnectionDetailsFactory;
import org.springframework.boot.testcontainers.service.connection.ContainerConnectionSource;

/**
 * Factory for creating {@link GrpcPythonServerContainerConnectionDetails} from a running
 ...
 * @see GrpcPythonServerContainerConnectionDetails
 * @see ContainerConnectionDetailsFactory
 * @author w4t3rcs
 * @since 1.0.0
 */
public class GrpcPythonServerConnectionDetailsFactory extends ContainerConnectionDetailsFactory<PythonGrpcServerContainer, GrpcPythonServerConnectionDetailsFactory.GrpcPythonServerContainerConnectionDetails> {
    /**
    ...
    /**
     * Creates {@link GrpcPythonServerContainerConnectionDetails} from the given container source.
     *
     * @param source the container connection source
     * @return a non-null connection details object
     */
    @Override
    protected GrpcPythonServerContainerConnectionDetails getContainerConnectionDetails(ContainerConnectionSource<PythonGrpcServerContainer> source) {
        return new GrpcPythonServerContainerConnectionDetails(source);
    }
     ...
     */
    public static class GrpcPythonServerContainerConnectionDetails extends ContainerConnectionDetailsFactory.ContainerConnectionDetails<PythonGrpcServerContainer> implements GrpcPythonServerConnectionDetails {
        /**
         ...
         */
        protected GrpcPythonServerContainerConnectionDetails(ContainerConnectionSource<PythonGrpcServerContainer> source) {
            super(source);
        }
