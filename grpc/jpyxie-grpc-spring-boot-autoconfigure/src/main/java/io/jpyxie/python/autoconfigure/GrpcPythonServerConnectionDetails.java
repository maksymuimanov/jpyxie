 ...
 * @since 1.0.0
 */
public interface GrpcPythonServerConnectionDetails extends ConnectionDetails {
    /**
    ...
    /**
     * Creates an immutable {@link GrpcPythonServerConnectionDetails} instance with the given parameters.
     *
     ...
     * @return non-{@code null} {@link GrpcPythonServerConnectionDetails} instance
     */
    static GrpcPythonServerConnectionDetails of(String token, String uri) {
        return new GrpcPythonServerConnectionDetails() {
            @Override
