 ...
 * <p>
 * When a method is annotated with {@code @PythonBefore}, the specified Python script
 * or file will be executed immediately before the method execution.
 * </p>
 * <p>
...
public @interface PythonBefore {
     ...
     * </p>
     *
     * @return the Python script content or file path to execute before the method
     */
    @AliasFor("script")
