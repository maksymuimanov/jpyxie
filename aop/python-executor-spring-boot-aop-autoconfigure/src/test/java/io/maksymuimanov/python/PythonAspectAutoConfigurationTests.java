...
import io.maksymuimanov.python.autoconfigure.PythonAspectAutoConfiguration;
...
@SpringBootTest
@AutoConfigureJson
@ContextConfiguration(classes = PythonAspectAutoConfiguration.class)
class PythonAspectAutoConfigurationTests {
    @Autowired
