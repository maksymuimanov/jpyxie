...
public final class TestConstants {
    ...
    //Resolver constants
    public static final Py4JResolverProperties PY4J_RESOLVER_PROPERTIES = new Py4JResolverProperties("from py4j.java_gateway import JavaGateway, GatewayParameters", "gateway = JavaGateway(\n\tgateway_parameters=GatewayParameters(\n\t\t%s\n\t)\n)", new String[]{"address=\"localhost\""});
