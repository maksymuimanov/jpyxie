...
import io.jpyxie.python.PythonRestServerContainer;
import io.jpyxie.python.autoconfigure.RestPythonServerConnectionDetails;
import org.springframework.boot.testcontainers.service.connection.ContainerConnectionDetailsFactory;
import org.springframework.boot.testcontainers.service.connection.ContainerConnectionSource;

/**
 * Factory for creating {@link RestPythonServerContainerConnectionDetails} from a running
 ...
 * @see RestPythonServerConnectionDetails
 * @see ContainerConnectionDetailsFactory
 * @author w4t3rcs
 * @since 1.0.0
 */
public class RestPythonServerConnectionDetailsFactory extends ContainerConnectionDetailsFactory<PythonRestServerContainer, RestPythonServerConnectionDetailsFactory.RestPythonServerContainerConnectionDetails> {
    /**
    ...
    /**
     * Creates {@link RestPythonServerContainerConnectionDetails} from the given container source.
     *
     * @param source the container connection source
     * @return a non-null connection details object
     */
    @Override
    protected RestPythonServerContainerConnectionDetails getContainerConnectionDetails(ContainerConnectionSource<PythonRestServerContainer> source) {
        return new RestPythonServerContainerConnectionDetails(source);
    }
     ...
     */
    public static class RestPythonServerContainerConnectionDetails extends ContainerConnectionDetails<PythonRestServerContainer> implements RestPythonServerConnectionDetails {
        /**
         ...
         */
        protected RestPythonServerContainerConnectionDetails(ContainerConnectionSource<PythonRestServerContainer> source) {
            super(source);
        }
